let { mergeProperties, mapObject, parseAttributes, renderAttributes } = require('./utils');

describe('utils', () => {
  describe('mapObject', () => {
    it('creates a new object', () => {
      let testObj = { a: 1 };
      let mappedObj = mapObject(testObj, (key, value) => value);
    ...
    it('maps the values via the mapper function', () => {
      let testObj = { a: 1, b: 2 };
      let mappedObj = mapObject(testObj, (key, value) => value * 2);
  ...
  describe('parseAttributes', () => {
    ...
    it('should parse attributes with quotes within quotes', () => {
      let attrs = parseAttributes('a=\'o"n"e\' b="t\'w\'o"');
      expect(attrs).toEqual({ a: 'o"n"e', b: 't\'w\'o' });
    });

    it('should parse attributes with spaces in their values', () => {
      let attrs = parseAttributes('a="one and two" b="three and four"');
