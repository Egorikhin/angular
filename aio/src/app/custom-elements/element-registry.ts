...
export let ELEMENT_MODULE_LOAD_CALLBACKS_AS_ROUTES = [
  {
...
export let ELEMENT_MODULE_LOAD_CALLBACKS_TOKEN = new InjectionToken<Map<string, LoadChildrenCallback>>('aio/elements-map');

/** Map of possible custom element selectors to their lazy-loadable module paths. */
export let ELEMENT_MODULE_LOAD_CALLBACKS = new Map<string, LoadChildrenCallback>();
