...

{
  describe('extractStyleUrls', () => {
    ...
    it('should not resolve "url()" urls', () => {
      ...
      let resolvedCss = extractStyleUrls(urlResolver, 'http://ng.io', css).style;
    ...
    it('should extract "@import" urls', () => {
      ...
      @import "2.css";
      `;
      let styleWithImports = extractStyleUrls(urlResolver, 'http://ng.io', css);
    ...
    it('should keep /*# sourceURL... */ and /*# sourceMappingURL... */ comments', () => {
      ...
      let styleWithSourceMaps = extractStyleUrls(urlResolver, 'http://ng.io', css);
    ...
    it('should extract "@import urls and keep rules in the same line', () => {
      let css = `@import url('some.css');div {color: red};`;
      let styleWithImports = extractStyleUrls(urlResolver, 'http://ng.io', css);
    ...
    it('should leave absolute non-package @import urls intact', () => {
      let css = `@import url('http://server.com/some.css');`;
      let styleWithImports = extractStyleUrls(urlResolver, 'http://ng.io', css);
    ...
    it('should resolve package @import urls', () => {
      let css = `@import url('package:a/b/some.css');`;
      let styleWithImports = extractStyleUrls(new FakeUrlResolver(), 'http://ng.io', css);
      expect(styleWithImports.style.trim()).toEqual(``);
